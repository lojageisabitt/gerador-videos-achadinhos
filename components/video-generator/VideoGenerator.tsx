...
import { DEFAULT_COLORS } from "@/lib/generator-config";
...
export function VideoGenerator() {
  ...
  const reset = () => { clearImages(); setColors(DEFAULT_COLORS); setSpeed("normal"); setPlayKey((key) => key + 1); };
  ...
  return <main className={styles.shell}>
    ...
    <div className={styles.workspace}>
      <div className={styles.panel}><ImageUploader images={images} error={error} onAdd={addImages} onRemove={removeImage} onMove={moveImage} /><StyleControls colors={colors} speed={speed} onColors={setColors} onSpeed={setSpeed} />
      ...
      <div ref={previewRef}><VideoPreview key={playKey} images={images} colors={colors} speed={speed} /></div>
    </div>
